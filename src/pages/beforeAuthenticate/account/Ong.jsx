                ...
                <BoxOne className="d-flex flex-column align-items-center">
                    ...
                    <form className="mt-3 d-flex flex-column align-items-center">
                        ...
                        <BoxOneInput className="d-flex flex-column">
                            ...
                            id="cnpj" 
                            className="mb-1" 
                            onChange={e => VMasker(e.target, ['99.999.999/9999-99', '99.999.999/9999-99'])}/>
                        ...
                        <BoxOneInput className="d-flex flex-column">
                            ...
                            <input type="text" 
                            onChange={e => VMasker(e.target, ['(99) 9999-9999', '(99) 99999-9999'])}
                            id="telefone"
                            className="mb-1" />
                        ...
                        <BoxTwoInput className="d-flex flex-column flex-sm-row">
                            <div className="mr-3">
                                ...
                                <input type="text" 
                                onChange={e => VMasker(e.target, ['99999-999', '99999-999'])} 
                                id="cep"
                                className="mb-1" />
